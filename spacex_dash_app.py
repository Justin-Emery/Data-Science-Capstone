...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        values='class count',
        names='class',
        title=f'Launch Site Success Rate {entered_site}')
        return fig
...
def get_scatter_chart(entered_site,slider_value):
    df1 = spacex_df[spacex_df['Payload Mass (kg)'].between(slider_value[0],slider_value[1])]
    if entered_site == 'ALL':
        fig2=px.scatter(df1,
        x='Payload Mass (kg)',
        y='class',
        color='Booster Version Category',
        title='Outcome by Payload Mass')
        return fig2
    else:
